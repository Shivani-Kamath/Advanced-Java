...
<head>
    ...
    <script>
        /* auto‑refresh every second to remove expired cookies */
        setTimeout(function () {
...
<body>
    ...
    <table class="cookie-table">
        ...
        <tbody>
            <%
                /* Retrieve the cookie list kept in session */
                ...
                if (cookieList != null) {
                    ...
                    while (it.hasNext()) {
                        Map<String, String> cookie = it.next();
                    ...
                    session.setAttribute("cookieList", cookieList); // save back
                }
